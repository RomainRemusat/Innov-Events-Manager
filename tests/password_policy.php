...
// Contrôle autonome de la politique de mot de passe et des comptes de démonstration.
...
foreach ($cases as $password => $expected) {
    if ($validate->invoke($controller, $password) !== $expected) {
        throw new RuntimeException('Politique de mot de passe non respectée.');
    }
}
...
echo "OK : politique de mot de passe, quatre comptes conformes et sels distincts.\n";
